...
class KeySearcher:
    ...
    def save_key(self, private_bytes: bytes, public_bytes: bytes, public_hex: str, pattern: str) -> None:
        ...
        with open(filepath, 'w', encoding='utf-8') as f:
            ...
            f.write(f"   set prv.key {private_hex}\n\n")
            f.write("   Important: Make sure to use the complete 128-character private key.\n")
            f.write("   The command will change the device's private key immediately.\n\n")
